...
if(isset($_POST['submit']))
{
    ...
    $result1 = mysqli_query($con,'select * from user where user_id="'.$username.'"');
...
<head>
    ...
    <body>
        ...
        <div class="detail-box">
            ...
            <form method="post">
            <p>User ID</p>
            <input type="text" name="username" placeholder="Enter User ID" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required>
